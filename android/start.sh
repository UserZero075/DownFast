...
if [ ! -f "servidor_v0.4.1.zip" ]; then
    echo "Descargando servidor.zip..."
    wget https://raw.githubusercontent.com/UserZero075/DownFast/main/android/servidor_v0.4.1.zip
    unzip -o servidor_v0.4.1.zip -d servidor_v0.4.1
fi

cd servidor_v0.4.1/servidor_\(Termux\)/
