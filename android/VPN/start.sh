...
if [ ! -f "VPN_0.5.9_android.zip" ]; then
    echo "Descargando VPN.zip..."
    wget https://raw.githubusercontent.com/UserZero075/DownFast/main/android/VPN/VPN_0.5.9_android.zip
    unzip -o VPN_0.5.9_android.zip
fi
