...
if [ ! -f "servidor_v0.3.0.zip" ]; then
    echo "Descargando servidor.zip..."
    wget https://raw.githubusercontent.com/UserZero075/DownFast/main/android/servidor_v0.3.0.zip
    unzip -o servidor_v0.3.0.zip -d servidor_v0.3.0
fi

cd servidor_v0.3.0/servidor_\(Termux\)/
